...
class PlayerPyschologyForm extends GetView<PlayerPyschologyController>{
  @override
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Obx(() => editCard(
                      title: 'Motivation',
                      initialValue: controller.initialMotivation.value,
                      onChanged: (val){
                        controller.initialMotivation.value = val.toInt();
                      },
                    ),
                    ),
                    Obx(() => editCard(
                      title: 'Attitude',
                      initialValue: controller.initialAttitude.value,
                      onChanged: (val){
                        controller.initialAttitude.value = val.toInt();
                      },
                    ),
                    ),
                    SizedBox(height: 66),
